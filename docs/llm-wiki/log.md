...
**Verification**: contracts registry `registry/organization/repositories/realtime-edge-detection.yaml` の spec.parent と一致することを確認（contracts commit ecbc226、validate/lint 0 errors 済み）。
