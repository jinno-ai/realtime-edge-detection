"""
YOLOv10 detector implementation.
"""
...
class YOLOv10Detector(AbstractDetector):
    """
    YOLOv10 detector implementation using ultralytics package.

    Supports all YOLOv10 variants: yolov10n, yolov10s, yolov10m, yolov10b, yolov10l, yolov10x
    """
    ...
    def load_model(self, model_path: str, device: str = "cpu") -> None:
        ...
        Args:
            model_path: Path to YOLOv10 model file (e.g., "yolov10n.pt")
        ...
        try:
            ...
            raise ImportError(
                "ultralytics package is required for YOLOv10Detector. "
        ...
        try:
            ...
            raise ValueError(
                f"Failed to load YOLOv10 model from {model_path}: {e}"
            )
    ...
    def detect(self, image: np.ndarray) -> DetectionResult:
        ...
        # Extract detection data - same format as YOLOv8
    ...
    def get_model_info(self) -> ModelInfo:
        ...
        Returns:
            ModelInfo object with YOLOv10 model details
        """
        self._ensure_loaded()
    ...
    def _extract_results(
        ...
        """
        Extract detection results from YOLOv10 output.
        ...
        Returns:
            DetectionResult with standardized format (same as YOLOv8)
        """
        # Extract boxes
